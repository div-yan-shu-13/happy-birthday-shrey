...
import { Heart, PartyPopper, Check, X, SmilePlus } from "lucide-react";
...
// --- NEW VIBRANT PALETTE ---
const palette = {
  bgTop: "#FFFBF7", // Warm cream at the top
  bgBottom: "#FBC2C2", // Deeper, more saturated blush at the bottom
  textPrimary: "#4A2E2E",
  textSecondary: "#6D4C4C", // Slightly richer secondary text
  textOnButton: "#FFFFFF",
  buttonBg: "#E26D8E", // A stronger, deeper, more confident rose
  buttonHover: "#C95F7F", // Darker shade of the new rose
  ...
  confettiColors: ["#FBC2C2", "#E26D8E", "#C95F7F"], // Updated confetti
};
...
const quizData = [
  // ... your quiz data ...
  {
    ...
    correct: 1,
    hint: "It was where the echoes of first meetings linger...",
  },
  {
    question: "Which was the first movie we watched together?",
    options: ["Perks of being a wallflower", "Before sunrise", "Pearl"],
    correct: 2,
    hint: "Our first story unfolded with sunrises and conversations.",
  },
  {
    question:
